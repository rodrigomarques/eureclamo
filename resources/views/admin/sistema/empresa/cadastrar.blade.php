...
<div class="col-xs-12">
    <form method="post" action="{{ route('admin::empresa::cadastrar')}}" class="well">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <h3 class="page-header">Cadastrar Empresa</h3>
    <div class="row">
    <div class="form-group col-xs-12">
        Razão Social *
        <input type="text" name="razao" id="razao" required class="form-control">
    </div>
    ...
    <div class="form-group col-xs-2">
        SIGLA *
        <input type="text" name="sigla" id="sigla" maxlength="4" required class="form-control">
    </div>
    </div>
