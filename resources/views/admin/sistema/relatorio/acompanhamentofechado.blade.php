...
<div class="col-xs-12">
    <h3 class="page-header" id="titulo" style="cursor: pointer">Relatório de Acompanhamento (Manifestação fechada)</h3>
    <form method="post" id="formulario" action="{{ route('admin::relatorio::acompanhamentofechado')}}" class="well">
